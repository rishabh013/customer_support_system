...
class DataIngestion:
    """DataIngestion class to handle the entire data transformation and ingestion process into AstraDB vector store."""
    ...
    def _load_env_variables(self):
        ...
        required_vars = ["GOOGLE_API_KEY", "OPENAI_API_KEY", "ASTRA_DB_API_ENDPOINT", "ASTRA_DB_APPLICATION_TOKEN", "ASTRA_DB_KEYSPACE"]
